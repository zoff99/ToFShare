...
@LargeTest
public class ShowMaintenanceInfo
{
    ...
    public void Test_Startup()
    {
        ...
        */
        ...
        intent.setClassName("com.zoffcc.applications.tofshare", "com.zoffcc.applications.trifa.MaintenanceActivity");
    ...
    // Scroll until the TextView with specific ID is visible
    public void scrollToTextViewById(int id) {
        // Perform scrollTo() on the specific TextView
        onView(withId(id))
                .perform(scrollTo());
